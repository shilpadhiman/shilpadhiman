...
<!-- <script type="text/javascript">
    ...
    data:{chat_massage: chat_massage},
    beforeSend:function (){
...
$(document).on("click","#send_chat", function(){
    ...
    var chat_massage= $.trim($('#chat_massage_area').html());
    if(chat_massage != ''){
    alert(url +'/dashboard/chatmassage');	
